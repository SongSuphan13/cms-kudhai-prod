<?php
/**
 * Template Name: KUDHai — วิริยะประกันภัย
...
kudhai_v2_set_page( 'car-insurance/viriyah-insurance' );
get_header();
?>
...
<section class="co-cta">
  <div class="container">
    ...
    <div class="cta-row">
      <a href="<?php echo esc_url( home_url( '/contact-us/' ) ); ?>" class="btn btn-primary">ปรึกษาแผนประกันกับ คัดให้</a>
      <a href="<?php echo esc_url( home_url( '/contact-us/#topics' ) ); ?>" class="btn btn-ghost">ขอใบเสนอราคาประกันรถยนต์</a>
    </div>
  </div>
</section>
