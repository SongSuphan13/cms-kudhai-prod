...
kudhai_v2_set_page( 'car-insurance/roojai-insurance' );
get_header();
...
<section class="article-content container">
  <div class="prose">
    ...
    <div class="companies-note"><span>อ่านเพิ่มเติม: <a href="<?php echo esc_url( home_url( '/car-insurance/' ) ); ?>">ประกันรถยนต์</a> · <a href="<?php echo esc_url( home_url( '/car-insurance/#types' ) ); ?>">เปรียบเทียบประกันรถยนต์ชั้น 1, 2+ และ 3+</a></span></div>
...
<section class="co-cta">
  <div class="container">
    ...
    <div class="cta-row">
      <a href="<?php echo esc_url( home_url( '/contact-us/#topics' ) ); ?>" class="btn btn-primary">เช็กเบี้ยประกันรถยนต์</a>
