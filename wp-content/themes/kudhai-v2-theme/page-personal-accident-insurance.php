<?php
/**
 * Template Name: KUDHai — ประกันอุบัติเหตุ (PA)
...
kudhai_v2_set_page( 'personal-accident-insurance' );
get_header();
?>
...
<img class="insurance-hero-image" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/pages/personal-accident-insurance-hero-v2.png' ) ); ?>" width="2172" height="724" alt="คู่รักเดินพักผ่อนพร้อมจักรยานและหมวกกันน็อกในสวน" fetchpriority="high" decoding="async">
