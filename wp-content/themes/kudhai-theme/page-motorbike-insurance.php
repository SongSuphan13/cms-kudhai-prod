...
<section class="co-hero">
  <div class="container co-hero-inner">
    ...
    <span class="eyebrow">
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><circle cx="5.5" cy="17.5" r="2.5"/><circle cx="18.5" cy="17.5" r="2.5"/><path d="M8 17.5h8M6 12l2.5-4.5H12l1 3h4l1.5 2.5M11 12l2-4"/></svg>
      ประกันรถมอเตอร์ไซค์
    </span>
