...
<section class="co-hero">
  <div class="container co-hero-inner">
    ...
    <span class="eyebrow">
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M4 17V8a1 1 0 0 1 1-1h12a2 2 0 0 1 2 2v8M4 17h15M4 17a1.5 1.5 0 0 0 3 0M16 17a1.5 1.5 0 0 0 3 0M7 12h10"/></svg>
      ประกันรถตู้
    </span>
    <h1>ประกันรถตู้</h1>
