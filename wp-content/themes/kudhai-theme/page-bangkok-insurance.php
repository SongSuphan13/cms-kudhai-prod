...
<section class="article-content container" id="type-detail-content">
  <div class="prose">
    ...
    <div class="callout">
      ...
      <p>บทความนี้เป็นข้อมูลเบื้องต้นเกี่ยวกับผลิตภัณฑ์ของกรุงเทพประกันภัยเพื่อการเปรียบเทียบ ไม่ได้หมายความว่าเราแนะนำให้ซื้อกับกรุงเทพประกันภัยเพียงบริษัทเดียว ดู<a href="<?php echo esc_url( home_url( '/insurance-companies/' ) ); ?>">การเปรียบเทียบบริษัทประกันภัยอื่นที่เราแนะนำ</a>ประกอบการตัดสินใจด้วย</p>
    </div>
